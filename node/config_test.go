...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gjang.ipc", false, filepath.Join(os.TempDir(), "gjang.ipc")},
		{"data", "gjang.ipc", false, "data/gjang.ipc"},
		{"data", "./gjang.ipc", false, "./gjang.ipc"},
		{"data", "/gjang.ipc", false, "/gjang.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gjang.ipc", true, `\\.\pipe\gjang.ipc`},
		{"data", "gjang.ipc", true, `\\.\pipe\gjang.ipc`},
		{"data", `\\.\pipe\gjang.ipc`, true, `\\.\pipe\gjang.ipc`},
	}
