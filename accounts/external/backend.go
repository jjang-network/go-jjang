...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain jjang.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to jjang-type signature.
		signature[64] -= 27 // Transform V from Jjang-legacy to 0/1
	}
