...
// Package accounts implements high level Jjang account management.
package accounts
...
// Account represents an Jjang account located at a specific location defined
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain jjang.ChainStateReader)
...
func TextAndHash(data []byte) ([]byte, string) {
	msg := fmt.Sprintf("\x19Jjang Signed Message:\n%d%s", len(data), string(data))
