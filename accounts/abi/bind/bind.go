...
// Package bind generates Jjang contract Go bindings.
//
// Detailed usage document and tutorial available on the go-jjang Wiki page:
// https://github.com/jjang-network/go-jjang/wiki/Native-DApps:-Go-bindings-to-Jjang-contracts
package bind
