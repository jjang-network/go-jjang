...
type Config struct {
	InsecureUnlockAllowed bool // Wheter account unlocking in insecure environment is allowed
}
...
// cmd/gjang assumes once this func returns the backends have been already integrated.
