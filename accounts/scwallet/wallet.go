...
type Session struct {
	...
	verified bool                  // Wheter the pin has been verified in this session.
}
...
type walletStatus struct {
	...
	Initialized   bool // Wheter the card has been initialized with a private key
}
