...
// Package les implements the Light Jjang Subprotocol.
package les
...
import (
	...
	"github.com/jjang-network/go-jjang/common/mclock"
	...
	"github.com/jjang-network/go-jjang/les/downloader"
	"github.com/jjang-network/go-jjang/les/vflux"
	vfc "github.com/jjang-network/go-jjang/les/vflux/client"
	"github.com/jjang-network/go-jjang/light"
...
func New(stack *node.Node, config *ethconfig.Config) (*LightJjang, error) {
...
func (s *LightJjang) VfluxRequest(n *enode.Node, reqs vflux.Requests) vflux.Replies {
	if !s.udpEnabled {
		return nil
	}
...
func (s *LightJjang) vfxVersion(n *enode.Node) uint {
	if n.Seq() == 0 {
		var err error
		if !s.udpEnabled {
			return 0
...
func (s *LightJjang) prenegQuery(n *enode.Node) int {
	if s.vfxVersion(n) < 1 {
...
// APIs returns the collection of RPC services the jjang package offers.
// NOTE, some of these services probably need to be moved to somewhere else.
func (s *LightJjang) APIs() []rpc.API {
...
func (s *LightJjang) ResetWithGenesisBlock(gb *types.Block) {
	s.blockchain.ResetWithGenesisBlock(gb)
}

func (s *LightJjang) BlockChain() *light.LightChain      { return s.blockchain }
func (s *LightJjang) TxPool() *light.TxPool              { return s.txPool }
func (s *LightJjang) Engine() consensus.Engine           { return s.engine }
func (s *LightJjang) LesVersion() int                    { return int(ClientProtocolVersions[0]) }
func (s *LightJjang) Downloader() *downloader.Downloader { return s.handler.downloader }
func (s *LightJjang) EventMux() *event.TypeMux           { return s.eventMux }
func (s *LightJjang) Merger() *consensus.Merger          { return s.merger }

// Protocols returns all the currently configured network protocols to start.
func (s *LightJjang) Protocols() []p2p.Protocol {
...
// light jjang protocol implementation.
func (s *LightJjang) Start() error {
