...
import (
	...
	"github.com/jjang-network/go-jjang/accounts/abi/bind/backends"
	...
	"github.com/jjang-network/go-jjang/contracts/checkpointoracle/contract"
	...
	"github.com/jjang-network/go-jjang/les/checkpointoracle"
	"github.com/jjang-network/go-jjang/les/flowcontrol"
	vfs "github.com/jjang-network/go-jjang/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some jang to user1
		...
		case 1:
			...
			// bankUser transfers more jang to user1
		...
		case 2:
			...
			// bankUser transfer some jang to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
