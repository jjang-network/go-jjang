...
type Downloader struct {
	...
	snapSync       bool         // Wheter to run state sync over the snap protocol
...
// these are zero.
func (d *Downloader) Progress() jjang.SyncProgress {
...
func (d *Downloader) fetchHeaders(p *peerConnection, from uint64) error {
	...
	pivoting := false           // Wheter the next request is pivot verification
