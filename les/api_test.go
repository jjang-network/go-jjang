...
import (
	...
	ethdownloader "github.com/jjang-network/go-jjang/eth/downloader"
	...
	"github.com/jjang-network/go-jjang/p2p/simulations"
	"github.com/jjang-network/go-jjang/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	jjang, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, jjang, &config)
	if err != nil {
		return nil, err
	}
	return jjang, nil
