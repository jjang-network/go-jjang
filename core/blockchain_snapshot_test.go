...
// It can be used for testing that restart Gjang normally.
...
// It can be used for testing that restart Gjang after the crash.
...
// Tests a Gjang restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gjang was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gjang was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gjang was running with snapshot enabled. Then restarts without
...
// Tests the Gjang was running with snapshot enabled and resetHead is applied.
...
// Tests the Gjang was running with a complete snapshot and then imports a few
