...
// Package state provides a caching layer atop the Jjang state trie.
package state
...
// StateDB structs within the jjang protocol are used to store anything
...
//
// Carrying over the balance ensures that Jang doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/jjang-network/go-jjang/pull/16485#issuecomment-380438527),
