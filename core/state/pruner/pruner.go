...
pruning. Remember don't start the Gjang without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gjang snapshot prune-state --help" for more details.
`
