...
// NewID calculates the Jjang fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Jjang fork ID from an existing chain instance.
