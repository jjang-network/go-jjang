...
// Package types contains data types related to Jjang consensus.
package types
...
// Header represents a block header in the Jjang blockchain.
type Header struct {
...
// Block represents an entire block in the Jjang blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Jjang RLP block format.
