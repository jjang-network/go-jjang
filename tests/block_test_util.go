...
// Package tests implements execution of Jjang JSON tests.
package tests
...
/* See https://github.com/jjang-network/tests/wiki/Blockchain-Tests-II

   Wheter a block is valid or not is a bit subtle, it's defined by presence of
