 ...
 * @author Gary Rong<garyrong@jjang.org>, Martin Swende <martin.swende@jjang.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the jjang.
    uint sectionSize;
