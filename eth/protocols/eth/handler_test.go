...
// testBackend is a mock implementation of the live Jjang message handler. Its
...
func testGetNodeData(t *testing.T, protocol uint) {
	...
	generator := func(i int, block *core.BlockGen) {
		switch i {
		case 0:
			// In block 1, the test bank sends account #1 some jang.
			...
			block.AddTx(tx)
		case 1:
			// In block 2, the test bank sends some more jang to account #1.
