...
// JjangAPI provides an API to access Jjang full node-related information.
type JjangAPI struct {
	e *Jjang
}

// NewJjangAPI creates a new Jjang protocol API for full nodes.
func NewJjangAPI(e *Jjang) *JjangAPI {
	return &JjangAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *JjangAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *JjangAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *JjangAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *JjangAPI) Mining() bool {
...
func NewMinerAPI(e *Jjang) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Jjang full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Jjang) *AdminAPI {
...
// DebugAPI is the collection of Jjang full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Jjang) *DebugAPI {
