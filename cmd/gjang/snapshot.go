...
import (
	...
	"github.com/jjang-network/go-jjang/core/state/snapshot"
	...
	"github.com/jjang-network/go-jjang/trie"
...
var (
	snapshotCommand = &cli.Command{
		...
		Subcommands: []*cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale jjang state data based on the snapshot",
				ArgsUsage: "<root>",
				Action:    pruneState,
				...
				Description: `
gjang snapshot prune-state <state-root>
...
during the use of Gjang, please also specify it here for correct deletion. Otherwise
...
`,
			},
			{
				...
				Description: `
gjang snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gjang snapshot check-dangling-storage <state-root> traverses the snap storage 
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gjang snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gjang snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabasePathFlags),
				Description: `
gjang snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gjang dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gjang dump', but uses the snapshots
