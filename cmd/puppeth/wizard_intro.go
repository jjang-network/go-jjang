...
// setting up a new or managing an existing Jjang private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Jjang private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Jjang network down to  |")
	...
	log.Info("Administering Jjang network", "name", w.network)
