...
type wizard struct {
	...
	services map[string][]string   // Jjang services known to be running on servers
...
// converts it to an Jjang address. If an empty line is entered, the default
// value is returned.
