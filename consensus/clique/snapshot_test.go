...
// mapped from textual names used in the tests below to actual Jjang private
...
// address retrieves the Jjang address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Jjang address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/jjang-network/go-jjang/issues/17593). Whilst this
