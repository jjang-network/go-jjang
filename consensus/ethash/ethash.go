...
// all blocks' seal as valid, though they still have to conform to the Jjang
// consensus rules.
...
// still have to conform to the Jjang consensus rules.
...
// they still have to conform to the Jjang consensus rules.
