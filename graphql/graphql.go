...
// Package graphql provides a GraphQL interface to Jjang node data.
package graphql
...
// Account represents an Jjang account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Jjang transaction.
...
// Block represents an Jjang block.
...
type CallData struct {
	From                 *common.Address // The Jjang address the call is from.
	To                   *common.Address // The Jjang address the call is to.
