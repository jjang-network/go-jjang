...
// Package ethclient provides a client for the Jjang RPC API.
package ethclient
...
// Client defines typed wrappers for the Jjang RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*jjang.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (jjang.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q jjang.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q jjang.FilterQuery, ch chan<- types.Log) (jjang.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q jjang.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg jjang.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg jjang.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg jjang.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*jjang.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg jjang.CallMsg) (uint64, error) {
...
func toCallArg(msg jjang.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *jjang.SyncProgress {
	if p == nil {
		return nil
	}
	return &jjang.SyncProgress{
