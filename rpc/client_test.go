...
// This test reproduces https://github.com/jjang-network/go-jjang/issues/17837 where the
...
// It is the reproducer for https://github.com/jjang-network/go-jjang/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-jjang-test-ipc-%d-%d", os.Getpid(), rand.Int63())
