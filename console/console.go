...
import (
	...
	"github.com/jjang-network/go-jjang/internal/jsre"
	"github.com/jjang-network/go-jjang/internal/jsre/deps"
	"github.com/jjang-network/go-jjang/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Jjang requests through
...
// Welcome show summary of current Gjang instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gjang JavaScript console!\n\n"

	// Print some generic Gjang metadata
