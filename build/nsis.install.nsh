Name "gjang ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/jjang-network/go-jjang/issues"
!define UPDATEURL "https://github.com/jjang-network/go-jjang/releases"
!define ABOUTURL "https://github.com/jjang-network/go-jjang#jjang-go"
...
# Install gjang binary
Section "Gjang" GJANG_IDX
  SetOutPath $INSTDIR
  file {{.Gjang}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gjang.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gjang.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gjang incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gjang outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gjang UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gjang incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gjang.exe" "" "" "Jjang" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gjang outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gjang.exe" "" "" "Jjang" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gjang UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gjang.exe" "" "" "Jjang" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "JJANG_SOCKET" "R" "HKLM" "\\.\pipe\gjang.ipc"
  ${EnvVarUpdate} $0 "JJANG_SOCKET" "A" "HKLM" "\\.\pipe\gjang.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GJANG_IDX}
    SectionGetSize ${GJANG_IDX} $0
