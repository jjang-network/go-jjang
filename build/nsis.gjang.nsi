...
# 1. install gjang for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gjang
# 5. create gjang, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable JJANG_SOCKET
...
!define GROUPNAME "Jjang"
!define APPNAME "Gjang"
!define DESCRIPTION "Official Go implementation of the Jjang protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gjang is installed global
