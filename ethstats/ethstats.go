...
import (
	...
	ethproto "github.com/jjang-network/go-jjang/eth/protocols/eth"
...
type backend interface {
	...
	SyncProgress() jjang.SyncProgress
}
...
// Service implements an Jjang netstats reporting daemon that pushes local
